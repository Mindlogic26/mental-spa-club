...
async def generate_flower(request: Request):
    ...
    # Using the standard V1 URL
    url = f"https://generativelanguage.googleapis.com/v1/models/gemini-1.5-flash:generateContent?key={api_key}"
    
    payload = {
        "contents": [{"parts": [{"text": f"The user is feeling {mood}. Recommend one specific flower and a short, 1-sentence inspirational quote. Format as: Flower Name: [Name]. Quote: [Quote]."}]}]
    }
